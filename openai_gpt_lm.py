...
def main():
    ...
    def pre_process_dataset(encoded_dataset, input_length):
        ...
        for i, tokens in enumerate(encoded_dataset):
            ...
            lm_labels[i,  : len(tokens)-1] = tokens[1 : len(tokens)] #+ [tokenizer.special_tokens['<END>']]
    ...
    if args.do_train:
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            output_model_file = os.path.join(args.output_dir, "yelp_language_model_{}.bin".format(epoch+1))
